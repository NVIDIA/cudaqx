...
.. doxygenfunction:: cudaq::qec::get_pcm_for_rounds(const cudaq::qec::sparse_binary_matrix &, std::uint32_t, std::uint32_t, std::uint32_t, bool, bool)
...
.. doxygenfunction:: cudaq::qec::pcm_is_sorted(const std::vector<std::vector<std::uint32_t>> &, std::uint32_t);
