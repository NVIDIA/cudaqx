...
The artifact is `SKILL.md` inside `.claude/skills/cuda-qx-build/`. Companion
...
`.claude/skills/_shared/repo_map.md`.
...
- Shared repo map: `.claude/skills/_shared/repo_map.md`
- Runtime API skills:
  - `.claude/skills/cuda-qx-qec/SKILL.md`
  - `.claude/skills/cuda-qx-solvers/SKILL.md`
