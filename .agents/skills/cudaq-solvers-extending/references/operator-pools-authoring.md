...
`cudaq-solvers-chemistry/references/operator-pools-using.md`.
...
- Run VQE / ADAPT / GQE using the new pool:
  `cudaq-solvers-algorithms/references/{vqe,gqe}.md`.
- Benchmark against built-ins: `cudaq-benchmarking`.
