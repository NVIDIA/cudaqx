...
void addGeneralizedDoubleExcitation(std::vector<cudaq::spin_op> &ops,
  ...
  if (p > q && r > s) {
    ...
    cudaq::spin_op op_term_temp = c * cudaq::spin::y(s) * parity_b *
                                  cudaq::spin::x(r) * cudaq::spin::x(q) *
                                  parity_a * cudaq::spin::x(p);
    op_term_temp += c * cudaq::spin::x(s) * parity_b * cudaq::spin::y(r) *
                    cudaq::spin::x(q) * parity_a * cudaq::spin::x(p);
    op_term_temp += c * cudaq::spin::y(s) * parity_b * cudaq::spin::y(r) *
                    cudaq::spin::y(q) * parity_a * cudaq::spin::x(p);
    op_term_temp += c * cudaq::spin::y(s) * parity_b * cudaq::spin::y(r) *
                    cudaq::spin::x(q) * parity_a * cudaq::spin::y(p);
    op_term_temp -= c * cudaq::spin::x(s) * parity_b * cudaq::spin::x(r) *
                    cudaq::spin::y(q) * parity_a * cudaq::spin::x(p);
    op_term_temp -= c * cudaq::spin::x(s) * parity_b * cudaq::spin::x(r) *
                    cudaq::spin::x(q) * parity_a * cudaq::spin::y(p);
    op_term_temp -= c * cudaq::spin::x(s) * parity_b * cudaq::spin::y(r) *
                    cudaq::spin::y(q) * parity_a * cudaq::spin::y(p);
    op_term_temp -= c * cudaq::spin::y(s) * parity_b * cudaq::spin::x(r) *
                    cudaq::spin::y(q) * parity_a * cudaq::spin::y(p);
