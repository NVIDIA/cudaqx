...
sys.path.insert(0, os.path.abspath('/home/.cudaq'))
sys.path.insert(0, os.path.abspath('/workspace/dev/cudaqx-hub-mren/build/python'))
...
nbsphinx_thumbnails = {
    ...
    '**': '/workspace/dev/cudaqx-hub-mren/docs/sphinx/_static/cuda_quantum_icon.svg'
}
...
templates_path = ['/workspace/dev/cudaqx-hub-mren/docs/sphinx/_templates']
...
html_css_files = ['/workspace/dev/cudaqx-hub-mren/docs/sphinx/_static/cudaq_override.css']

# Add any paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
html_static_path = ['/workspace/dev/cudaqx-hub-mren/docs/sphinx/_static']
