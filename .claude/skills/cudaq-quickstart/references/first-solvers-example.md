...
|----------------------|------|
| Try a bigger molecule | `cudaq-solvers-chemistry` SKILL.md (geometry, basis, active space) |
| Try ADAPT-VQE (auto-growing ansatz) | `cudaq-solvers-algorithms/references/vqe.md` |
| Run QAOA on a MaxCut problem | `cudaq-solvers-algorithms/references/qaoa.md` |
| Use GQE (transformer-driven) | `cudaq-solvers-algorithms/references/gqe.md` |
| Compare classical baselines | `cudaq-benchmarking` SKILL.md |

At this point the user has a working solvers stack. Hand them off to
`cudaq-solvers-algorithms` SKILL.md for the algorithm index.
