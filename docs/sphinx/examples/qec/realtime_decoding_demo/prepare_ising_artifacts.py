...
# ============================================================================ #
"""Prepare the Ising artifact directory for this example's trt_decoder profile.
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    prepare.add_argument(
        ...
        required=True,
        type=Path,
        help="path to the built surface_code_ising_realtime_decoding "
        "generator (this example's build/ directory)",
    )
    prepare.add_argument(
        "--artifacts-dir",
        type=Path,
...
def prepare(args: argparse.Namespace) -> None:
    ...
    print("Run the example with: ./run_realtime_decoding.sh --decoder "
          f"trt_decoder --ising-artifacts-dir {destination} ...")
