...
sys.path.insert(0, os.path.abspath('/usr/local/cudaq'))
sys.path.insert(0, os.path.abspath('/workspaces/cudaqx/cudaqx/build/python'))
...
nbsphinx_thumbnails = {
    ...
    '**': '/workspaces/cudaqx/cudaqx/docs/sphinx/_static/cuda_quantum_icon.svg'
}
...
templates_path = ['/workspaces/cudaqx/cudaqx/docs/sphinx/_templates']
...
html_css_files = ['/workspaces/cudaqx/cudaqx/docs/sphinx/_static/cudaq_override.css']

# Add any paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
html_static_path = ['/workspaces/cudaqx/cudaqx/docs/sphinx/_static']
...
nitpick_ignore = [
    ...
    ('cpp:identifier', 'cudaq::M2DSparseMatrix'),
