...
TEST(BravyiKitaev, testH2Hamiltonian) {
  ...
  cudaq::spin_op_term i4(0, 4);
  cudaq::spin_op gold =
      -0.1064770114930045 + 0.04540633286914125 * i4 * x(0) * z(1) * x(2) +
      0.04540633286914125 * i4 * x(0) * z(1) * x(2) * z(3) +
      0.04540633286914125 * i4 * y(0) * z(1) * y(2) +
      0.04540633286914125 * i4 * y(0) * z(1) * y(2) * z(3) +
      0.17028010135220506 * i4 * z(0) + 0.1702801013522051 * i4 * z(0) * z(1) +
      0.16560682358174256 * i4 * z(0) * z(1) * z(2) +
      0.16560682358174256 * i4 * z(0) * z(1) * z(2) * z(3) +
      0.12020049071260128 * i4 * z(0) * z(2) +
      0.12020049071260128 * i4 * z(0) * z(2) * z(3) +
      0.1683359862516207 * i4 * z(1) -
      0.22004130022421792 * i4 * z(1) * z(2) * z(3) +
      0.17407289249680227 * i4 * z(1) * z(3) - 0.22004130022421792 * i4 * z(2);
...
TEST(BravyiKitaev, testSRLCase0) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(-2.0, 0.0) * i20 * z(2) + double_complex(2.0, 0.0);
...
TEST(BravyiKitaev, testSRLCase1) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(1.0, 0.0) * i20 * z(1) * x(2) * y(3) * z(5) * y(6) +
      double_complex(-1.0, 0.0) * i20 * z(1) * y(2) * y(3) * z(5) * x(6) +
      double_complex(0.0, -1.0) * i20 * z(1) * x(2) * y(3) * z(5) * x(6) +
      double_complex(0.0, -1.0) * i20 * z(1) * y(2) * y(3) * z(5) * y(6);
  auto [terms, residuals] = (result - gold).get_raw_data();
  for (auto r : residuals)
    EXPECT_NEAR(std::abs(r), 0.0, 1e-4);
}
...
TEST(BravyiKitaev, testSRLCase2) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(-1.0, 0.0) * i20 * z(1) * y(2) * y(3) * z(4) * x(5) +
      double_complex(0.0, 1.0) * i20 * z(1) * x(2) * y(3) * z(4) * x(5) +
      double_complex(1.0, 0.0) * i20 * z(1) * x(2) * y(3) * y(5) +
      double_complex(0.0, 1.0) * i20 * z(1) * y(2) * y(3) * y(5);
...
TEST(BravyiKitaev, testSRLCase3) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold = double_complex(1.0, 0.0) * i20 * z(0) * y(1) * y(2) +
                        double_complex(0.0, -1.0) * i20 * z(0) * y(1) * x(2) +
                        double_complex(1.0, 0.0) * i20 * x(1) * x(2) +
                        double_complex(0.0, 1.0) * i20 * x(1) * y(2);
...
TEST(BravyiKitaev, testSRLCase4) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(-1.0, 0.0) * i20 * y(0) * x(1) * y(3) * z(4) * x(5) +
      double_complex(0.0, -1.0) * i20 * x(0) * x(1) * y(3) * z(4) * x(5) +
      double_complex(1.0, 0.0) * i20 * x(0) * x(1) * y(3) * y(5) +
      double_complex(0.0, -1.0) * i20 * y(0) * x(1) * y(3) * y(5);
...
TEST(BravyiKitaev, testSRLCase6) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold = double_complex(1.0, 0.0) * i20 * x(18) +
                        double_complex(0.0, -1.0) * i20 * y(18) +
                        double_complex(0.0, 1.0) * i20 * z(17) * y(18) * z(19) +
                        double_complex(-1.0, 0.0) * i20 * z(17) * x(18) * z(19);
...
TEST(BravyiKitaev, testSRLCase7) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(0.0, 1.0) * i20 * z(3) * z(4) * x(5) * y(7) * z(9) *
          z(10) * x(11) +
      double_complex(-1.0, 0.0) * i20 * z(3) * y(5) * y(7) * z(9) * z(10) *
          x(11) +
      double_complex(1.0, 0.0) * i20 * z(3) * z(4) * x(5) * y(7) * y(11) +
      double_complex(0.0, 1.0) * i20 * z(3) * y(5) * y(7) * y(11);
...
TEST(BravyiKitaev, testSRLCase8) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(0.0, -1.0) * i20 * z(3) * z(5) * z(6) * y(7) * z(8) *
          x(9) * x(11) +
      double_complex(1.0, 0.0) * i20 * z(3) * z(5) * z(6) * y(7) * y(9) *
          x(11) +
      double_complex(1.0, 0.0) * i20 * x(7) * z(8) * x(9) * x(11) +
      double_complex(0.0, 1.0) * i20 * x(7) * y(9) * x(11);
...
TEST(BravyiKitaev, testSRLCase9) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(-1.0, 0.0) * i20 * y(9) * y(11) * z(13) * z(14) +
      double_complex(0.0, -1.0) * i20 * z(8) * x(9) * y(11) * z(13) * z(14) +
      double_complex(-1.0, 0.0) * i20 * z(7) * z(8) * x(9) * x(11) * z(15) +
      double_complex(0.0, 1.0) * i20 * z(7) * y(9) * x(11) * z(15);
...
TEST(BravyiKitaev, testSRLCase10) {
  ...
  cudaq::spin_op_term i20(0, 20);
  cudaq::spin_op gold =
      double_complex(0.0, -1.0) * i20 * z(1) * z(2) * y(3) * z(5) * z(6) +
      double_complex(1.0, 0.0) * i20 * x(3) * z(5) * z(6) +
      double_complex(-1.0, 0.0) * i20 * z(1) * z(2) * x(3) * z(7) +
      double_complex(0.0, 1.0) * i20 * y(3) * z(7);
