...
`cudaq-qec-realtime/references/autonomous-decoder.md`. That
...
For full details: `cudaq-qec-realtime/references/autonomous-decoder.md`.
...
- Real-time deployment: `cudaq-qec-realtime`.
- AI-decoder integration (TensorRT under the hood): `cudaq-qec-ai-decoders`.
- Benchmark against existing decoders: `cudaq-benchmarking`.
- Profile: `cudaq-profiling-perf`.
