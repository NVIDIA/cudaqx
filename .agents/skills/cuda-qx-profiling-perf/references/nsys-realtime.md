...
The Phase 3 step in real-time decoding (`cuda-qx-qec-realtime/references/in-kernel.md`)
...
- Compare two implementations methodically: `cuda-qx-benchmarking/references/decoder-comparison.md`.
