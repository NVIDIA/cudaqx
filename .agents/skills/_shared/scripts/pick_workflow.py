...
INTENT_TABLE: dict[str, dict[str, Any]] = {
    ...
    "build": {
        "skill":
            "cuda-qx-build",
        "reference":
            ".agents/skills/cuda-qx-build/references/build.md",
        "commands": [
    ...
    "build-wheels": {
        "skill":
            "cuda-qx-build",
        "reference":
            ".agents/skills/cuda-qx-build/references/wheels.md",
    ...
    "build-docs": {
        "skill": "cuda-qx-build",
        "reference": ".agents/skills/cuda-qx-build/references/docs.md",
        "commands": [
