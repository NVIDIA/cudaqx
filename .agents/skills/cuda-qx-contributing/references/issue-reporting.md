...
## Environment
(paste the env block from cuda-qx-benchmarking/references/reproducibility.md)
...
[ ] If applicable: cudaqx git SHA / pip-list versions / stack trace.
...
- Once a bug is filed and accepted, fix it via PR:
  `pr-workflow.md`.
- For environment capture details: `cuda-qx-benchmarking/references/reproducibility.md`.
