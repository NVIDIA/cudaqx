...
`upccgsd`, `ceo`, etc.), see
`cudaq-solvers-algorithms/references/vqe.md` "State Preparation Kernels".
...
| Wrong qubit count at runtime | `num_qubits` / `num_orbitals` confusion — see `cudaq-solvers-chemistry/SKILL.md` Convention #2 |
