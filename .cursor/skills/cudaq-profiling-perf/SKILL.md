---
name: "cudaq-profiling-perf"
title: "CUDA-Q Libraries Profiling and Performance"
description: >-
  Profile and optimize CUDA-Q Libraries code: NVTX ranges for the realtime QEC
...
tags: [cudaq, profiling, nsys, ncu, nvtx, cuda-graph, performance, latency, throughput]
...
# CUDA-Q Libraries Profiling and Performance
...
grade comparisons (→ `cudaq-benchmarking`).
...
- For latency benchmarking methodology: `cudaq-benchmarking`.
- For the realtime path being profiled: `cudaq-qec-realtime`.
