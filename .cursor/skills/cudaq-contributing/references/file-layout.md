...
`libs/core/include/cudaq/core/` and include `extension_point.h`,
...
covers this — see `tests-run-locally.md`).
...
- Plugin-author specifics: `cudaq-qec-extending`, `cudaq-solvers-extending`.
