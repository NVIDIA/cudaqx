...
INTENT_TABLE: dict[str, dict[str, Any]] = {
    ...
    "build": {
        "skill":
            "cudaq-build",
        "reference":
            ".agents/skills/cudaq-build/references/build.md",
        "commands": [
    ...
    "build-wheels": {
        "skill":
            "cudaq-build",
        "reference":
            ".agents/skills/cudaq-build/references/wheels.md",
    ...
    "build-docs": {
        "skill": "cudaq-build",
        "reference": ".agents/skills/cudaq-build/references/docs.md",
        "commands": [
    ...
    "debug-import": {
        "skill": "cudaq-build",
        "reference": ".agents/skills/cudaq-build/references/install-triage.md",
        "commands": [
    ...
    "qec-decode": {
        "skill": "cudaq-qec-decode",
        "reference": ".agents/skills/cudaq-qec-decode/references/decode.md",
        "commands": [
    ...
    "qec-custom": {
        "skill":
            "cudaq-qec-extending",
        "reference":
            ".agents/skills/cudaq-qec-extending/references/code-python.md",
        "commands": [
    ...
    "qec-realtime": {
        "skill":
            "cudaq-qec-realtime",
        "reference":
            ".agents/skills/cudaq-qec-realtime/references/in-kernel.md",
        "commands": [
    ...
    "qec-ai-decoder": {
        "skill":
            "cudaq-qec-ai-decoders",
        "reference":
            ".agents/skills/cudaq-qec-ai-decoders/references/training.md",
        "commands": [
    ...
    "qec-debug": {
        "skill":
            "cudaq-qec-decode",
        "reference":
            ".agents/skills/cudaq-qec-decode/references/decode-triage.md",
        "commands": [
    ...
    "vqe": {
        "skill":
            "cudaq-solvers-algorithms",
        "reference":
            ".agents/skills/cudaq-solvers-algorithms/references/vqe.md",
        "commands": [
    ...
    "qaoa": {
        "skill":
            "cudaq-solvers-algorithms",
        "reference":
            ".agents/skills/cudaq-solvers-algorithms/references/qaoa.md",
        "commands": [
    ...
    "gqe": {
        "skill":
            "cudaq-solvers-algorithms",
        "reference":
            ".agents/skills/cudaq-solvers-algorithms/references/gqe.md",
        "commands": [
    ...
    "chemistry": {
        ...
        "reference":
            ".agents/skills/cudaq-solvers-chemistry/references/molecule-building.md",
        "commands": [
