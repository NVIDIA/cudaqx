...
std::vector<cudaq::spin_op_term> stabilizer_grid::get_spin_op_stabilizers() const {
...
std::vector<cudaq::spin_op_term> stabilizer_grid::get_spin_op_observables() const {
