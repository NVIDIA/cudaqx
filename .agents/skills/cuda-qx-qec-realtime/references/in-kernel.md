...
| `nv-qldpc-decoder` | `qec.nv_qldpc_decoder_config()` | many params; see `cuda-qx-qec-decode/references/decode-triage.md` `nv-qldpc-decoder parameters` table |
| `trt_decoder` | `qec.trt_decoder_config()` | path to `.engine`; see `cuda-qx-qec-ai-decoders` |
