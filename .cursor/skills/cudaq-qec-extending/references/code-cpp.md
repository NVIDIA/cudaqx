...
For the build path end-to-end, see `cudaq-build/references/build.md`.
...
- Decoder to pair: `decoder-cpp.md` or use a built-in decoder via
  `cudaq-qec-decode/references/decode.md`.
- For real-time targeting: `cudaq-qec-realtime`.
- Add docs for the new code: `cudaq-build/references/docs.md`.
