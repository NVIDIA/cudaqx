...
- Use the pool in ADAPT: `cudaq-solvers-algorithms/references/vqe.md` "ADAPT-VQE".
- Use the pool in GQE: `cudaq-solvers-algorithms/references/gqe.md`.
- Compare ADAPT depth/accuracy across pools: `cudaq-benchmarking`.
